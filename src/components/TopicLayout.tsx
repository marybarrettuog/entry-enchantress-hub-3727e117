...
const TopicLayout = ({ children, title, description, prevTopic, nextTopic }: TopicLayoutProps) => (
  <div className="min-h-screen bg-background">
    ...
    <div className="border-t border-border bg-muted/30 py-10">
      <div className="container mx-auto px-6 max-w-4xl flex flex-wrap items-center justify-center gap-4">
        {prevTopic && (
          <Link
            to={prevTopic.to}
          ...
          >
            ...
            <div>
              <p className="text-xs text-muted-foreground font-mono uppercase tracking-wider mb-1">Previous topic</p>
