...
const examples = [
  ...
  },
  {
    ...
    explanation: "Motor Vehicles (asset) increases — debit. Capital (equity/liability) increases — credit.",
    debitRule: "Asset ↑",
    creditRule: "Liability ↑",
  },
  {
    ...
    explanation: "Rent Expense increases — debit. Money goes out of the bank — credit.",
    debitRule: "Expense ↑",
    creditRule: "Bank Out",
  },
  {
  ...
  },
  {
    ...
    explanation: "Wages Expense increases — debit. Money goes out of the bank — credit.",
    debitRule: "Expense ↑",
    creditRule: "Bank Out",
  },
  {
    ...
    explanation: "Insurance Expense increases — debit. Money goes out of the bank — credit.",
    debitRule: "Expense ↑",
    creditRule: "Bank Out",
  },
  {
  ...
  },
  {
    ...
    explanation: "Sales Returns (expense/reduction of revenue) increases — debit. Accounts Receivable (asset) decreases — credit.",
    debitRule: "Expense ↑",
    creditRule: "Asset ↓",
  },
  {
    ...
    explanation: "Money comes into the bank — debit. Commission Received (gain) increases — credit.",
    debitRule: "Bank In",
    creditRule: "Gain ↑",
  },
  {
  ...
  },
  {
    ...
    explanation: "Accounts Payable (liability) decreases — debit. Money goes out of the bank — credit.",
    debitRule: "Liability ↓",
    creditRule: "Bank Out",
  },
  {
    ...
    explanation: "Money comes into the bank — debit. Cash (asset) decreases — credit.",
    debitRule: "Bank In",
    creditRule: "Asset ↓",
  },
  {
    ...
    explanation: "Cash (asset) increases — debit. Money goes out of the bank — credit.",
    debitRule: "Asset ↑",
    creditRule: "Bank Out",
  },
  {
  ...
  },
  {
    ...
    explanation: "Loan (liability) decreases — debit. Money goes out of the bank — credit.",
    debitRule: "Liability ↓",
    creditRule: "Bank Out",
  },
  {
    ...
    explanation: "Interest Expense increases — debit. Money goes out of the bank — credit.",
    debitRule: "Expense ↑",
    creditRule: "Bank Out",
  },
  {
  ...
  },
  {
    ...
    explanation: "Drawings (reduction of equity) increases — debit. Purchases (expense) decreases — credit.",
    debitRule: "Liability ↓",
    creditRule: "Expense ↓",
  },
  {
  ...
  },
  {
    ...
    explanation: "Prepayments (asset) increases — debit. Money goes out of the bank — credit.",
    debitRule: "Asset ↑",
    creditRule: "Bank Out",
  },
];
